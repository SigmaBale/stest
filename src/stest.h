...
#define ASSERT_STR_EQ(src, dst) _ASSERT_STR_EQ(src, dst, __FILE__, __LINE__, __func__)
#endif
...
#define ASSERT_STR_NEQ(src, dst) _ASSERT_STR_NEQ(src, dst, __FILE__, __LINE__, __func__)
#endif
